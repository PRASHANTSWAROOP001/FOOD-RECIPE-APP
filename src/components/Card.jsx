...
import { getRecipeDetails, addFav } from '../features/favouriteRecipe.js';

function Card({ image_url, title, id }) {
  ...
  return (
    <div className="w-72 h-fit rounded-b-xl bg-white duration-500 hover:scale-105 pb-2 shadow-sm ">
      ...
      <div className="w-full flex justify-between px-2 ">
        <button onClick={()=>(addToFav(id,title,image_url))} className=" px-3 py-2 bg-purple-300 hover:bg-purple-400">
          Add To Fav
        </button>
        <button
